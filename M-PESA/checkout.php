...
.button button {
  ...
  .button button i {
   ...
   <div class="container">
    ...
    <div class="price">
        <h1>Hello there, make payment here</h1>
    </div>
        ...
        <div class="card">
            ...
            <div class="row number">
                <div class="info">
                    ...
                    <input id="cardnumber" type="text" name="phone_number" maxlength="10" placeholder="0700000000/01000000"/>
                </div>
            </div>
        </div>
    </div>
    ...
    <p style="color:#8F92C3;line-height:1.7;margin-top:5rem;">Copyright 2024 | All Rights Reserved | Pool Table & Accessories Store</p>
</div>
   </body>
</html>
